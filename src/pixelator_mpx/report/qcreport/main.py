...
from pixelator_mpx.report.qcreport.collect import collect_report_data
from pixelator_mpx.report.qcreport.types import Metrics, SampleInfo
...
def make_report(
    ...
    """
    from pixelator_mpx.config import config, load_antibody_panel
