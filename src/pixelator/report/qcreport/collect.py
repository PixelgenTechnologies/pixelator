...
# CommandIndexTuple: typing.TypeAlias = Tuple[Dict[str, CommandInfo], Dict[str, CommandOptionDict]]
#
# def index_parameter_info(data: List[CommandInfo]) -> CommandIndexTuple:
