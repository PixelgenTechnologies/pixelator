...
def test_graph_backend_request_networkx():
    """Verify graph backend request networkx."""
...
def test_graph_backend_from_graph_type_unknown():
    """Verify graph backend from graph type unknown."""
...
class TestVertexClassesImplementVertexProtocol:
    """Represent test vertex classes implement vertex protocol."""
...
class TestEdgeClassesImplementEdgeProtocol:
    """Represent test edge classes implement edge protocol."""
...
class TestVertexSequenceClassesImplementVertexSequenceProtocol:
    """Represent test vertex sequence classes implement vertex sequence protocol."""
...
class TestEdgeSequenceClassesImplementEdgeSequenceProtocol:
    """Represent test edge sequence classes implement edge sequence protocol."""
...
class TestVertexClusteringClassesImplementVertexClusteringProtocol:
    """Represent test vertex clustering classes implement vertex clustering protocol."""
